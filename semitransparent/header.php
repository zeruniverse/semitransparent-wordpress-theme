...
<title><?php
	...
	if ( ( $paged >= 2 || $page >= 2 ) && ! is_404() )
		echo esc_html( ' | ' . sprintf( __( 'Page %s', 'SemiTransparent' ), max( $paged, $page ) ) );
...
<div id="page" class="hfeed">
	<header id="branding" role="banner">
			...
			<nav id="access" role="navigation">
				<h3 class="assistive-text"><?php _e( 'Main menu', 'SemiTransparent' ); ?></h3>
				<?php /* Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff. */ ?>
				<div class="skip-link"><a class="assistive-text" href="#content"><?php _e( 'Skip to primary content', 'SemiTransparent' ); ?></a></div>
				<?php if ( ! is_singular() ) : ?>
					<div class="skip-link"><a class="assistive-text" href="#secondary"><?php _e( 'Skip to secondary content', 'SemiTransparent' ); ?></a></div>
				<?php endif; ?>
